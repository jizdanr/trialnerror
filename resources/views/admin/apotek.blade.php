    ...
    <div class="container mx-auto mt-8">
        ...
        <div id="apotek-form">
            <form action="{{ route('store.apotek') }}" class="pt-20" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="provinsi" class="block text-gray-700 font-bold mb-2">Pilih Provinsi Apotek:</label>
                    ...
                    <label for="kota" class="block text-gray-700 font-bold mb-2">Pilih Kota Apotek:</label>
